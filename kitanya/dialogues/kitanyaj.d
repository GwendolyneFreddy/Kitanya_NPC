...
IF ~IsGabber(Player1)~ THEN BEGIN TalkedToByPC
  ...
  IF ~Global("Chapter","GLOBAL",6)~ THEN REPLY @315 GOTO Rhynn
  IF ~~ THEN REPLY @316 GOTO KitPast
  IF ~GlobalLT("Chapter","GLOBAL",4)~ THEN REPLY @317 GOTO KitCowled
...
IF ~~ THEN BEGIN Irenicus
  SAY @395
  IF ~GlobalGT("Chapter","GLOBAL",4)~ THEN GOTO IrenicusSoul
  IF ~GlobalLT("Chapter","GLOBAL",5)~ THEN GOTO IrenicusNoKnow
END
