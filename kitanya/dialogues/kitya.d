...
IF ~~ THEN BEGIN PCQuestions
  ...
  + ~Global("ViconiaRomanceActive","GLOBAL",2)
     IsValidForPartyDialogue("Viconia")~ + @152 DO ~SetGlobal("R#kityaVicExclusive2","GLOBAL",1)~ EXTERN VICONIJ KitJoinedExclusiveChain
  + ~GlobalLT("Chapter","GLOBAL",4)~ + @270 + ImoenCowled
  + ~GlobalLT("Chapter","GLOBAL",4)~ + @271  + KitKnowsJon
END
...
IF ~~ THEN BEGIN ReturnChallenge
 SAY @398 = @399
 +~GlobalLT("Chapter","GLOBAL",4)~+@400+ ReturnImmy
 +~GlobalGT("Chapter","GLOBAL",4)~+@401+ ReturnIrenicus1
 ++@402+ ReturnIrenicus1
 ++@403+ ReturnWealth
END
...
IF ~~ THEN BEGIN ReturnWealth
 SAY @416
 +~GlobalLT("Chapter","GLOBAL",4)~+@417+ ReturnImmy
 +~GlobalGT("Chapter","GLOBAL",4)~+@418+ ReturnIrenicus1
 ++@402+ ReturnIrenicus1
 ++@419 EXIT
END
...
IF ~~ THEN BEGIN ReturnQuestions
 SAY @420
 +~GlobalLT("Chapter","GLOBAL",4)~+@421+ ReturnQuestionsCowled
 ++@422+ ReturnQuestionsIrenicus
 +~GlobalGT("Chapter","GLOBAL",5)~+@423+ ReturnQuestionsSulda
 +~GlobalGT("Chapter","GLOBAL",5)~+@424+ ReturnQuestionsRhynn
END
